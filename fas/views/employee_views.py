...
class EmployeeListView(ListView):
    model = Employee
    template_name = "fas/employee_list.html"
    paginate_by = 20
...
class EmployeeDetailView(DetailView):
    model = Employee
    template_name = "fas/employee_detail.html"
...
class EmployeeCreateView(CreateView):
    ...
    template_name = "fas/employee_create.html"
...
class EmployeeUpdateView(UpdateView):
    ...
    form_class = EmployeeForm
    # fields = ['name', 'email', 'phone', 'department']
    template_name = "fas/employee_update.html"
    initial = {}
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
...
class EmployeeDeleteView(DeleteView):
    model = Employee
    template_name = "fas/employee_delete.html"
    slug_field = 'slug'
    slug_url_kwarg = 'slug'
    pk_url_kwarg = 'pk'
    context_object_name = "employee"
